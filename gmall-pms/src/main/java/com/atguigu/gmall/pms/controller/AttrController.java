...
public class AttrController {
    ...
    public ResponseVo<List<AttrEntity>> queryAttrsByCidAndTypeOrSearchType(@PathVariable("cid") Long cid,
        ...
        List<AttrEntity> categoryEntities = this.attrService.queryAttrsByCidAndTypeOrSearchType(cid, type, searchType);
        return ResponseVo.ok(categoryEntities);
    }

    @ApiOperation("分页查询")
    @GetMapping("group/{gid}")
    public ResponseVo<List<AttrEntity>> queryAttrsById(@PathVariable("gid") Long gid) {
